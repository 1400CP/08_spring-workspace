...
//	public void ajaxMethod1(String name, int age) {
	...
	*/
	 ...
	 * 	=> 단, 문자열 리턴하면, 포워딩 방식 => 응답뷰로 인식해서 해당 뷰페이지를 찾을 것임
	 * 	따라서 내가 리턴하는 문자열이 응답뷰가 아닌 응답데이터야 라는 걸 알려주는
	 * 	어노테이션을 붙여야 한다. @ResponseBody를 붙여야됨.
	 */
	@ResponseBody
//	@RequestMapping("ajax1.do") // 한글이 있다면 추가해야 한다
